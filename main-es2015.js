...
let HelperDetailsComponent = class HelperDetailsComponent {
    constructor(helpersService, activatedRoute, fb, router) {
...
HelperDetailsComponent.ctorParameters = () => [
...
let HelperItemComponent = class HelperItemComponent {
};
...
let HelpersListComponent = class HelpersListComponent {
...
HelpersListComponent.ctorParameters = () => [
...
let HelpersService = class HelpersService {
    ...
    getAllHelpers(paramObj = {}) {
        let params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]();
        Object.keys(paramObj).forEach((key) => params = params.set(key, paramObj[key]));
        return this.configService.getConfig().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["concatMap"])((config) => this.http.get(config.helpersApi, { params })));
    }
    getHelperById(id) {
        return this.configService.getConfig().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["concatMap"])((config) => this.http.get(`${config.helpersApi}${id}`)));
    }
    updateHelperById(formValue, id) {
        return this.configService.getConfig().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["concatMap"])((config) => this.http.put(`${config.helpersApi}${id}`, formValue)));
    }
    deleteHelperById(id) {
        return this.configService.getConfig().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["concatMap"])((config) => this.http.delete(`${config.helpersApi}${id}`)));
    }
};
...
let ManagerDetailsComponent = class ManagerDetailsComponent {
    constructor(managersService, activatedRoute, fb, router) {
...
ManagerDetailsComponent.ctorParameters = () => [
...
let ManagerItemComponent = class ManagerItemComponent {
};
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
...
let ManagersService = class ManagersService {
    ...
    getAllManagers(paramObj = {}) {
        let params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]();
        Object.keys(paramObj).forEach((key) => params = params.set(key, paramObj[key]));
        return this.configService.getConfig().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["concatMap"])((config) => this.http.get(config.managersApi, { params })));
    }
    getManagerById(id) {
        return this.configService.getConfig().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["concatMap"])((config) => this.http.get(`${config.managersApi}${id}`)));
    }
    updateManagerById(formValue, id) {
        return this.configService.getConfig().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["concatMap"])((config) => this.http.put(`${config.managersApi}${id}`, formValue)));
    }
    deleteManagerById(id) {
        return this.configService.getConfig().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["concatMap"])((config) => this.http.delete(`${config.managersApi}${id}`)));
    }
};
...
let AuctionLotComponent = class AuctionLotComponent {
    constructor() { }
};
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
...
let AuctionService = class AuctionService {
    ...
    getActiveLots() {
        return this.configService.getConfig().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["concatMap"])((config) => Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["zip"])(this.http.get(config.activeLotsApi), this.http.get(config.childrenApi), this.http.get(config.sheltersApi), this.http.get(config.donationItemsApi))), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(([listOfLots, children, shelters, dontationItems]) => {
            const childrenObj = children.reduce((acc, curr) => (Object.assign({ [curr.id]: curr }, acc)), {});
            const shetlerObj = shelters.reduce((acc, curr) => (Object.assign({ [curr.id]: curr }, acc)), {});
            const dontationItemsObj = dontationItems.reduce((acc, curr) => (Object.assign({ [curr.id]: curr }, acc)), {});
            return listOfLots.map((lot) => {
...
let NeedsItemDetailsComponent = class NeedsItemDetailsComponent {
    constructor(needService, route) {
...
NeedsItemDetailsComponent.ctorParameters = () => [
...
let NeedService = class NeedService {
    ...
    getNeeds(paramObj = {}) {
        let params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]();
        Object.keys(paramObj).forEach((key) => params = params.set(key, paramObj[key]));
        return this.configService.getConfig().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["concatMap"])((config) => this.http.get(config.needsApi, { params })));
    }
    getDetails(id = '') {
        return this.configService.getConfig().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["concatMap"])((config) => {
            return this.http.get(`${config.needsApi}/${id}`);
        }));
    }
};
...
let QuestService = class QuestService {
    ...
    getQuests(paramObj = {}) {
        let params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]();
        Object.keys(paramObj).forEach((key) => params = params.set(key, paramObj[key]));
        return this.configService.getConfig().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["concatMap"])((config) => this.http.get(config.questsApi, { params })));
    }
};
...
let LoginComponent = class LoginComponent {
    constructor(formBuilder, authenticationService, router, route, notifier) {
    ...
    ngOnInit() {
        this.route.queryParams.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["takeUntil"])(this.destroy$)).subscribe((params) => {
            if (params.auth) {
...
let RegistrationUserComponent = class RegistrationUserComponent {
    constructor(formBuilder, authenticationService, router, notifier) {
        this.formBuilder = formBuilder;
        this.authenticationService = authenticationService;
        this.router = router;
        this.notifier = notifier;
...
let AuthenticateInterceptor = class AuthenticateInterceptor {
    constructor(authStateService, notifierService) {
        this.authStateService = authStateService;
        this.notifierService = notifierService;
    }
    intercept(req, next) {
        return this.authStateService.getState().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["concatMap"])(token => {
            if (token) {
                req = req.clone({
...
AuthenticateInterceptor.ctorParameters = () => [
...
let PermissionDirective = class PermissionDirective {
    constructor(permissionService, templateRef, viewContainer, currentRoles) {
    ...
    updateView(permission) {
        ...
        const currentRole = role ? _models_permission_roles_enum__WEBPACK_IMPORTED_MODULE_4__["Roles"].Admin : _models_permission_roles_enum__WEBPACK_IMPORTED_MODULE_4__["Roles"].Guest;
        // ************************************************************************************** //
...
let PermissionService = class PermissionService {
    ...
    getPermissionByRole(role, permission) {
...
let AuthenticationService = class AuthenticationService {
    constructor(router, http, configService, authStateService) {
        this.router = router;
        this.http = http;
        this.configService = configService;
        this.authStateService = authStateService;
    ...
    login(loginData) {
        return this.configService.getConfig().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["concatMap"])(config => this.http.post(config.loginApi, loginData)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(tokenObj => {
            if (tokenObj.token) {
...
let ShelterCardDetailsComponent = class ShelterCardDetailsComponent {
    constructor(sheltersService, activatedRoute, notifierService, router, fb) {
    ...
    onSubmit() {
        ...
        let addressChange = Object.assign({}, this.profileForm.get('address').value);
...
let ShelterRegistrationComponent = class ShelterRegistrationComponent {
    constructor(sheltersService, router, notifierService) {
        this.sheltersService = sheltersService;
        this.router = router;
        this.notifierService = notifierService;
        this.error = '';
...
let SheltersService = class SheltersService {
    ...
    getShelters(paramObj = {}) {
        let params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]();
        Object.keys(paramObj).forEach((key) => params = params.set(key, paramObj[key]));
        return this.configService.getConfig().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["concatMap"])((config) => Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["zip"])(this.http.get(config.sheltersApi, { params }), this.http.get(config.childrenApi), this.http.get(config.representativesApi), this.http.get(config.addressApi))), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(([shelters, children, representatives, address]) => {
            const countChildren = children.reduce((acc, curr) => {
                acc[curr.childrenHouseID] = acc[curr.childrenHouseID] ? ++acc[curr.childrenHouseID] : 1;
                return acc;
            }, {});
            const representativesObj = representatives.reduce((acc, curr) => (Object.assign({ [curr.childrenHouseID]: curr }, acc)), {});
            const addressObj = address.reduce((acc, curr) => (Object.assign({ [curr.id]: curr }, acc)), {});
            return shelters.map((shelter) => (Object.assign({}, shelter, { children: countChildren[shelter.id], representative: representativesObj[shelter.id], address: addressObj[shelter.adressID] })));
        }));
    }
    getDetails(id = '') {
        return this.configService.getConfig().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["concatMap"])((config) => this.getShelter(config.sheltersApi, id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["concatMap"])((shelter) => Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["zip"])(Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(shelter), this.getAddress(config.addressApi, shelter.adressID), this.getLocation(config.locationApi, shelter.locationID))), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(([shelter, address, location]) => (Object.assign({}, shelter, { address,
            location }))))));
    }
    getShelter(api, id) {
    ...
    putShelterDetails(changeData) {
        return this.configService.getConfig().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["concatMap"])((config) => {
            ...
            return location$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["concatMap"])((location) => {
                if (location) {
                ...
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["zip"])(this.putShelter(config.sheltersApi, changeData.shelter, changeData.id), this.putAddress(config.addressApi, changeData.address, changeData.addressID));
            }));
        }));
    }
    putShelter(api, shelter, shelterId) {
        return shelter ? this.http.put(`${api}/${shelterId}`, this.createFormData(shelter)) : Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
    }
    postLocation(api, address) {
        return address ? this.http.post(api, this.createFormData(address)) : Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
    }
    putLocation(api, address, locationID) {
    ...
    putAddress(api, address, addressID) {
    ...
    deleteShelter(shelter) {
        return this.configService.getConfig().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["concatMap"])((config) => {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["zip"])(this.http.delete(`${config.sheltersApi}/${shelter.id}`), shelter.addressID ? this.http.delete(`${config.addressApi}/${shelter.adressID}`) : Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null), shelter.locationID ? this.http.delete(`${config.locationApi}/${shelter.locationID}`) : Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null));
        }));
    }
    createFormData(params) {
        const formData = new FormData();
        Object.entries(params).forEach(([key, value]) => value instanceof File ? formData.append(key, value, value.name) : formData.append(key, value));
        return formData;
    }
    registerShelter(form, file) {
        const addressData = {
        ...
        return this.configService.getConfig().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["concatMap"])((config) => {
            return this.registerAddressShelter(config.addressApi, this.createFormData(addressData)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["concatMap"])(address => {
    ...
    registerAddressShelter(api, addressData) {
        return this.http.post(api, addressData);
    }
    registrationShelter(api, shelterData) {
